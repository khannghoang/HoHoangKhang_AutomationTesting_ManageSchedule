...
import SOGIOQUYDOI_PAGE.TimKiemGiangVien_NamHoc_ChiTiet_XemTheoCaGiang_Page;

public class TimKiemGiangVien_NamHoc_ChiTiet_XemTheoCaGiang_Test {
	static WebDriver driver;
		...
		public void Setup2() throws InterruptedException {
			TimKiemGiangVien_NamHoc_ChiTiet_XemTheoCaGiang_Page MainPage = new TimKiemGiangVien_NamHoc_ChiTiet_XemTheoCaGiang_Page(driver);
		...
		public void SearchBangBieu2() throws InterruptedException, IOException {
			...
			System.out.println("Testcase 2:Tìm kiếm với Hiển thị 25 dữ liệu và xem theo ca giảng");
			String pasString = pasStringBuilder.toString();
			String faildString = faildBuilder.toString();
			System.out.println("Key word không hợp lệ " + faildString);
			System.out.println("Key Word hợp lệ " + pasString);
