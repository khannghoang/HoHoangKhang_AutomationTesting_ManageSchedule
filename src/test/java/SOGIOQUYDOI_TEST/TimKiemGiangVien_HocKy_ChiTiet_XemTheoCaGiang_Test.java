...
import SOGIOQUYDOI_PAGE.ThongKeSoGioQuyDoi_HocKy_ChiTiet_Page;
import SOGIOQUYDOI_PAGE.TimKiemGIangVien_HocKy_ChiTiet_Page;
import SOGIOQUYDOI_PAGE.TimKiemGIangVien_HocKy_ChiTiet_XemTheoCaGiang_Page;

public class TimKiemGiangVien_HocKy_ChiTiet_XemTheoCaGiang_Test {
	...
	public void Setup2() throws InterruptedException {
		TimKiemGIangVien_HocKy_ChiTiet_XemTheoCaGiang_Page Mainpage = new TimKiemGIangVien_HocKy_ChiTiet_XemTheoCaGiang_Page(driver);
	...
	public void SearchBangBieu1() throws InterruptedException, IOException {
		...
		for (int i = 0; i < sheet.getPhysicalNumberOfRows(); i++) {
			...
			Thread.sleep(500);
			WebElement searchbox = driver.findElement(By.xpath("//*[@id=\"tblStatisticsDetails_filter\"]/label/input"));
			searchbox.sendKeys(id);
			Thread.sleep(1000);
			WebElement dataTable = driver.findElement(By.xpath("//*[@id=\"tblStatisticsDetails\"]/tbody"));
		...
		System.out.println("Testcase 1:Tìm kiếm với Hiển thị 10 dữ liệu và xem theo ca giảng");
	...
	public void SearchBangBieu2() throws InterruptedException, IOException {
		...
		System.out.println("Testcase 4:Tìm kiếm với Hiển thị 25 dữ liệu và xem theo ca giảng");
		String pasString = pasStringBuilder.toString();
		String faildString = faildBuilder.toString();
		System.out.println("Key word không hợp lệ " + faildString);
		System.out.println("Key Word hợp lệ " + pasString);
	...
	public void SearchBangBieu3() throws InterruptedException, IOException {
		...
		System.out.println("Testcase 3:Tìm kiếm với Hiển thị 50 dữ liệu và xem theo ca giảng");
		String pasString = pasStringBuilder.toString();
		String faildString = faildBuilder.toString();
		System.out.println("Key word không hợp lệ " + faildString);
		System.out.println("Key Word hợp lệ " + pasString);
	...
	public void SearchBangBieu4() throws InterruptedException, IOException {
		...
		System.out.println("Testcase 4:Tìm kiếm với Hiển thị tất cả dữ liệu và xem theo ca giảng");
		String pasString = pasStringBuilder.toString();
		String faildString = faildBuilder.toString();
		System.out.println("Key word không hợp lệ " + faildString);
		System.out.println("Key Word hợp lệ " + pasString);
	...
	public void SearchBangBieu5() throws InterruptedException, IOException {
		...
		System.out.println("Testcase 5:Tìm kiếm với Hiển thị 10 dữ liệu với ký tự đặc biệt và xem theo ca giảng");
		String pasString = pasStringBuilder.toString();
		String faildString = faildBuilder.toString();
		System.out.println("Key word không hợp lệ " + faildString);
		System.out.println("Key Word hợp lệ " + pasString);
	...
	public void SearchBangBieu6() throws InterruptedException, IOException {
		...
		System.out.println("Testcase 6:Tìm kiếm với Hiển thị 25 dữ liệu với ký tự đặc biệt và xem theo ca giảng");
		String pasString = pasStringBuilder.toString();
		String faildString = faildBuilder.toString();
		System.out.println("Key word không hợp lệ " + faildString);
		System.out.println("Key Word hợp lệ " + pasString);
	...
	public void SearchBangBieu7() throws InterruptedException, IOException {
		...
		System.out.println("Testcase 7:Tìm kiếm với Hiển thị 50 dữ liệu với ký tự đặc biệt và xem theo ca giảng");
		String pasString = pasStringBuilder.toString();
		String faildString = faildBuilder.toString();
		System.out.println("Key word không hợp lệ " + faildString);
		System.out.println("Key Word hợp lệ " + pasString);
	...
	public void SearchBangBieu8() throws InterruptedException, IOException {
		...
		System.out.println("Testcase 8:Tìm kiếm với Hiển thị tất cả dữ liệu với ký tự đặc biệt và xem theo ca giảng");
		String pasString = pasStringBuilder.toString();
		String faildString = faildBuilder.toString();
		System.out.println("Key word không hợp lệ " + faildString);
		System.out.println("Key Word hợp lệ " + pasString);
