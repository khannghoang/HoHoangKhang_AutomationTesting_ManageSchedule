...
import SOGIOQUYDOI_PAGE.ThongKeSoGioQuyDoi_NamHoc_BangBieu_XemTheoCaGiang_Page;
...
public class ThongKeSoGioQuyDoi_NamHoc_BangBieu_XemTheoCaGiang_Test {
	...
	public void Action3() throws InterruptedException {
		System.out.println("Testcase 3:Chức năng xem danh sách thống kê số giờ quy đổi của giáo viên theo Năm Học hiển thị 50 dữ liệu với bảng biểu và xem theo ca giảng");
		Thread.sleep(2000);
		WebElement dropdown = driver.findElement(By.xpath("//*[@id=\"tblStatistics_length\"]/label/select"));
		Select select = new Select(dropdown);
	...
	public void Action4() throws InterruptedException {
		System.out.println("Testcase 4:Chức năng xem danh sách thống kê số giờ quy đổi của giáo viên theo Năm Học hiển thị tất cả dữ liệu với bảng biểu và xem theo ca giảng");
		Thread.sleep(2000);
		WebElement dropdown = driver.findElement(By.xpath("//*[@id=\"tblStatistics_length\"]/label/select"));
		Select select = new Select(dropdown);
