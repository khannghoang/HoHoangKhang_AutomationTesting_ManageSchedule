...
import SOGIOQUYDOI_PAGE.TimKiemGiangVien_NamHoc_ChiTiet_Page;

public class TimKiemGiangVien_NamHoc_ChiTiet_Test {
	static WebDriver driver;
		...
		public void Setup2() throws InterruptedException {
			TimKiemGiangVien_NamHoc_ChiTiet_Page MainPage = new TimKiemGiangVien_NamHoc_ChiTiet_Page(driver);
