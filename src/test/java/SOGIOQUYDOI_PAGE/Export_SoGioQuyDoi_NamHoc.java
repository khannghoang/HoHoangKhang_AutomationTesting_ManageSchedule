...
//
//		System.out.println("Testcase 5: Chức năng Export In ấn Số Giờ Quy Đổi theo Năm học và chọn ngành Tất cả và chọn xem theo ca giảng");
//		FileInputStream fis = new FileInputStream("K:\\Automation\\ExportSGQĐNH.xlsx");
//		XSSFWorkbook workbook = new XSSFWorkbook(fis);
//		XSSFSheet sheet = workbook.getSheetAt(0);
//		XSSFRow row = sheet.getRow(0);
...
//
//		System.out.println("Testcase 6: Chức năng Export Sao Chép Số Giờ Quy Đổi theo Năm học và chọn ngành Tất cả và chọn xem theo ca giảng");
//		FileInputStream fis = new FileInputStream("K:\\Automation\\ExportSGQĐNH.xlsx");
//		XSSFWorkbook workbook = new XSSFWorkbook(fis);
//		XSSFSheet sheet = workbook.getSheetAt(0);
//		XSSFRow row = sheet.getRow(0);
...
//		System.out.println("Testcase 9: Chức năng Export In ấn Số Giờ Quy Đổi theo Năm học và chọn ngành Tất Cả và chọn mục Chi Tiết");
//		FileInputStream fis = new FileInputStream("K:\\Automation\\ExportSGQĐNH.xlsx");
//		XSSFWorkbook workbook = new XSSFWorkbook(fis);
//		XSSFSheet sheet = workbook.getSheetAt(0);
//		XSSFRow row = sheet.getRow(0);
...
//		System.out.println("Testcase 10: Chức năng Export Sao Chép Số Giờ Quy Đổi theo Năm học và chọn ngành Tất cả và chọn mục Chi Tiết");
//		FileInputStream fis = new FileInputStream("K:\\Automation\\ExportSGQĐNH.xlsx");
//		XSSFWorkbook workbook = new XSSFWorkbook(fis);
//		XSSFSheet sheet = workbook.getSheetAt(0);
//		XSSFRow row = sheet.getRow(0);
...
//		driver.findElement(By.xpath("//*[@id=\"isLesson\"]")).click();
//
//		System.out.println("Testcase 13: Chức năng Export In ấn Số Giờ Quy Đổi theo Năm học và chọn ngành Tất cả và chọn mục Chi Tiết");
//		FileInputStream fis = new FileInputStream("K:\\Automation\\ExportSGQĐNH.xlsx");
//		XSSFWorkbook workbook = new XSSFWorkbook(fis);
//		XSSFSheet sheet = workbook.getSheetAt(0);
//		XSSFRow row = sheet.getRow(0);
...
//		System.out.println("Testcase 14: Chức năng Export Sao Chép Số Giờ Quy Đổi theo Năm học và chọn ngành Tất cả và chọn mục Chi Tiết");
//		FileInputStream fis = new FileInputStream("K:\\Automation\\ExportSGQĐNH.xlsx");
//		XSSFWorkbook workbook = new XSSFWorkbook(fis);
//		XSSFSheet sheet = workbook.getSheetAt(0);
//		XSSFRow row = sheet.getRow(0);
